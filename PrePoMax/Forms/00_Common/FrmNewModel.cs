...
namespace PrePoMax.Forms
{
    class FrmNewModel : UserControls.FrmPropertyListView, IFormBase
    {
        ...
        public GroupBox gbModelSpace; //private  my code
        public RadioButton rb2DPlaneStress; //private  my code
        public RadioButton rb3D; //private  my code
        private Controller _controller;
        private int _lvSelectedIndex;
        public RadioButton rb2DAxisymmetric; //private  my code
        public RadioButton rb2DPlaneStrain; //private  my code
        private bool _focusOK;
        private bool _cancelPossible;
        private string _appLanguage = "en"; //my cord
        ...
        {
            Console.WriteLine("FrmNewModel::InitializeComponent");
        ...
        /*public void SetLanguage(string language)
        {
            ...
            Console.WriteLine("FrmNewModel::SetLanguage:" + _appLanguage);
            ...
            else if (_appLanguage == "ja")
            {
                this.gbType.Text = "単位系タイプ";
