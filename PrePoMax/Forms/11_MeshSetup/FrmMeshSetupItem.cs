...
namespace PrePoMax.Forms
{
    class FrmMeshSetupItem : UserControls.FrmPropertyListView, IFormBase, IFormItemSetDataParent, IFormHighlight
    {
        ...
        // my code 
        public string MeshingParametersText = "Meshing Parameters";
        public string MeshRefinementText = "Mesh Refinement";
        public string ShellGmshText = "Shell Gmsh";
        public string ThickenShellMeshText = "Thicken Shell Mesh";
        public string TetrahedralGmshText = "Tetrahedral Gmsh";
        public string TransfiniteMeshText = "Transfinite Mesh";
        public string ExtrudeMeshText = "Extrude Mesh";
        public string SweepMeshText = "Sweep Mesh";
        public string RevolveMeshText = "Revolve Mesh";
        ...
        {
            Console.WriteLine("PopulateListOfMeshSetupItems()");

            bool twoD = _controller.Model.Properties.ModelSpace.IsTwoD();
            //
            ListViewItem item;
            // Meshing parameters
            //item = new ListViewItem("Meshing Parameters"); //　"メッシュパラメータ"
            item = new ListViewItem(MeshingParametersText); // my code
            ...
            item = new ListViewItem(MeshRefinementText); //my code
            ...
            item = new ListViewItem(ShellGmshText);  //my code
            ShellGmsh sg = new ShellGmsh(GetMeshSetupItemName("Shell_Gmsh"));
            ViewShellGmsh vsg = new ViewShellGmsh(sg);
            item.Tag = vsg;
            lvTypes.Items.Add(item);
            // Thicken shell mesh
            //item = new ListViewItem("Thicken Shell Mesh");
            item = new ListViewItem(ThickenShellMeshText); //my code
            ...
            item = new ListViewItem(TetrahedralGmshText); //my code
            ...
            item = new ListViewItem(TransfiniteMeshText); //my code
            ...
            if (!twoD)
            {
                ...
                item = new ListViewItem(ExtrudeMeshText); //my code
                ...
                item = new ListViewItem(SweepMeshText); //my code
