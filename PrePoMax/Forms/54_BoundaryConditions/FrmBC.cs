...
namespace PrePoMax.Forms
{
    class FrmBC : UserControls.FrmPropertyListView, IFormBase, IFormItemSetDataParent, IFormHighlight
    {
        ...
        private void InitializeComponent()
        {
            ...
            // gbProperties
            // 
            this.gbProperties.Size = new System.Drawing.Size(310, 403);
            // 
            // propertyGrid
            // 
            this.propertyGrid.Size = new System.Drawing.Size(298, 375);
            // 
            // btnOK
            // 
        ...
        protected override void OnPropertyGridPropertyValueChanged()
        {
            ...
            {
                if (property == nameof(vdr.NodeSetName) ||
        ...
        protected override bool OnPrepareForm(string stepName, string boundaryConditionToEditName)
        {
            ...
            if (_boundaryConditionToEditName == null)
            {
                // Different steps support different boundary conditions
                                       ...
                                       string[] amplitudeNames, string[] coordinateSystemNames)
        {
            ...
            if (step.IsBoundaryConditionSupported(displacementRotation))
            {
                ...
                vdr.PopulateDropDownLists(nodeSetNames, surfaceNames, referencePointNames, amplitudeNames, coordinateSystemNames);
                vdr.Color = color;
                item.Tag = vdr;
                lvTypes.Items.Add(item);
            }
        ...
        public bool IsGeometrySelectionIdBased()
        {
            ...
            if (boundaryCondition.CreationData != null && IsSelectionGeometryBased())
                return boundaryCondition.CreationData.IsGeometryIdBased(defaultMode);
